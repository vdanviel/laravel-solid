...
<div class="tocify-wrapper">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PATCHapi-item-alter-qnt">PATCH api/item/alter/qnt</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-order-register">
                                <a href="#endpoints-POSTapi-order-register">POST api/order/register</a>
                            </li>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: September 7, 2024</li>
    </ul>
</div>
...
<div class="bash-example">
    ...
    --data "{
    \"email\": \"octavia.berge@example.com\",
    \"password\": \"a\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="octavia.berge@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>octavia.berge@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"name\": \"ghkdvohnmtcrwjq\",
    \"email\": \"crohan@example.net\",
    \"phone_number\": \"qufpuy\",
    \"password\": \"\\\"3\'=\'q?I\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="ghkdvohnmtcrwjq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>ghkdvohnmtcrwjq</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="crohan@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>crohan@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must not be greater than 20 characters. Example: <code>qufpuy</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>"3'='q?I</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="elta.sporer@example.net"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>elta.sporer@example.net</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"id\": 13,
    \"name\": \"error\",
    \"email\": \"madge.harvey@example.net\",
    \"phone_number\": \"animi\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="madge.harvey@example.net"
               data-component="body">
    <br>
<p>Example: <code>madge.harvey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone_number</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --data "{
    \"name\": \"eum\",
    \"description\": \"Qui voluptatibus animi vero eligendi rerum.\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Qui voluptatibus animi vero eligendi rerum."
               data-component="body">
    <br>
<p>Example: <code>Qui voluptatibus animi vero eligendi rerum.</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    \"id_type\": 10,
    \"name\": \"vitae\",
    \"description\": \"Itaque perspiciatis ipsam doloremque est.\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Itaque perspiciatis ipsam doloremque est."
               data-component="body">
    <br>
<p>Example: <code>Itaque perspiciatis ipsam doloremque est.</code></p>
        </div>
        </form>
...
<p>Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-order-register">POST api/order/register</h2>
...
<span id="example-requests-POSTapi-order-register">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-order-register">
</span>
<span id="execution-results-POSTapi-order-register" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-order-register"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-order-register"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-order-register" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-order-register">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-order-register" data-method="POST"
      data-path="api/order/register"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-order-register', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-order-register"
                    onclick="tryItOut('POSTapi-order-register');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-order-register"
                    onclick="cancelTryOut('POSTapi-order-register');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-order-register"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-order-register"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-order-register"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="card_id"                data-endpoint="POSTapi-order-register"
               value="11"
               data-component="body">
    <br>
